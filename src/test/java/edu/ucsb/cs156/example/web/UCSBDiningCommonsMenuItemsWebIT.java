...
public class UCSBDiningCommonsMenuItemsWebIT extends WebTestCase {
    ...
    public void admin_user_can_create_edit_delete_ucsbdiningcommonsmenuitems() throws Exception {
        ...
        page.getByTestId("UCSBDiningCommonsMenuItemsForm-name").fill("Water");
        ...
        assertThat(page.getByTestId("UCSBDiningCommonsMenuItemsTable-cell-row-0-col-diningCommonsCode")).hasText("Portola");

        page.getByTestId("UCSBDiningCommonsMenuItemsTable-cell-row-0-col-Delete-button").click();

        assertThat(page.getByTestId("UCSBDiningCommonsMenuItemsTable-cell-row-0-col-diningCommonsCode")).not().isVisible();
    }
