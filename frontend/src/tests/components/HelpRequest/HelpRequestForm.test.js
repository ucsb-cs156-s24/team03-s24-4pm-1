...
describe("HelpRequestForm tests", () => {
    ...
    test("Correct Error messsages on bad input", async () => {
        ...
        await screen.findByText(/Requester Email must be in the format username@domain, e.g. cgaucho@ucsb.edu/);
    });
    ...
    test("Correct Error messsages on missing input", async () => {
        ...
        expect(screen.getByText(/Table or Breakout Room Required/)).toBeInTheDocument();
    ...
    test("No Error messsages on good input", async () => {
        ...
        expect(screen.queryByText(/Requester Email must be in the format username@domain, e.g. cgaucho@ucsb.edu/)).not.toBeInTheDocument();
